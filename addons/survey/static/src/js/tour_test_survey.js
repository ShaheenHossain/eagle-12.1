...
tour.register('test_survey', {
    ...
    [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.eagle.com?
        {
        ...
        {
            content: "For 'I use the contextual help in Eagle' checking 'Agree'",
        ...
        // Question: What do you think about the process views of Eagle, available in the web client ?
        {
            content: "For 'They help new users to understand Eagle' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to Eagle?
        {
