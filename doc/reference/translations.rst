...
automatically loaded by Eagle ERP when the corresponding language is installed (via
...
Eagle ERP automatically exports translatable strings from "data"-type content:
...
code, Eagle ERP cannot automatically export translatable terms so they
