...
The manifest file serves to declare a python package as an Eagle ERP module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within Eagle ERP, rough business domain for the module.
...
``depends`` (``list(str)``)
    Eagle ERP modules which must be loaded before this one, either because this
...
.. _existing categories:
     https://github.com/eagle/eagle/blob/12.0/eagle/addons/base/data/ir_module_category_data.xml
