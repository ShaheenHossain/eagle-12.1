...
.. danger::
    ...
    (to the same value), use :meth:`~eagle.models.Model.write`::
...
:meth:`~eagle.models.Model.filtered`
...
:meth:`~eagle.models.Model.sorted`
...
:meth:`~eagle.models.Model.mapped`
...
using :attr:`~eagle.models.Model.env` and gives access to the current user
(:attr:`~eagle.api.Environment.user`), the cursor
(:attr:`~eagle.api.Environment.cr`) or the context
(:attr:`~eagle.api.Environment.context`)::
...
:meth:`~eagle.models.Model.with_context`
...
:meth:`~eagle.models.Model.with_env`
...
:meth:`~eagle.models.Model.search`
   ...
   .. tip:: to just check if any record matches a domain, or count the number
             ...
             :meth:`~eagle.models.Model.search_count`

:meth:`~eagle.models.Model.create`
...
:meth:`~eagle.models.Model.exists`
...
:meth:`~eagle.api.Environment.ref`
...
:meth:`~eagle.models.Model.ensure_one`
...
* computed fields are automatically checked and recomputed, they do not need
  an ``onchange``
* for non-computed fields, the :func:`~eagle.api.onchange` decorator is used
...
:meth:`~eagle.models.BaseModel.invalidate_cache` method of the
:class:`~eagle.models.BaseModel` object.
...
* values of the :class:`~eagle.api.Environment` (cursor, user id and
  context) are passed explicitly to methods instead
* record data (:attr:`~eagle.models.Model.ids`) are passed explicitly to
...
Note that a method `create` decorated with :func:`~eagle.api.model` will always
be called with a single dictionary. A method `create` decorated with the variant
:func:`~eagle.api.model_create_multi` will always be called with a list of dicts.
...
.. autoclass:: eagle.models.Model
    ...
    .. attribute:: _auto
     ...
     .. tip:: To create a model without any table, inherit
              from ``eagle.models.AbstractModel``

    .. attribute:: _table

        Name of the table backing the model created when
        :attr:`~eagle.models.Model._auto`, automatically generated by
        default.
    ...
    .. attribute:: _inherits
        ...
        the fields of the :attr:`~eagle.models.Model._inherits`-ed model but
        ...
        .. warning::
            ...
            :attr:`~eagle.models.Model._inherits`-ed
    ...
    .. attribute:: create_date
        ...
        :type: :class:`~eagle.field.Datetime`
    ...
    .. attribute:: active
        ...
        :type: :class:`~eagle.fields.Boolean`
    ...
    .. attribute:: sequence
        ...
        :type: :class:`~eagle.fields.Integer`
    ...
    .. attribute:: state
        ...
        :type: :class:`~eagle.fields.Selection`
    ...
    .. attribute:: parent_id
        ...
        :type: :class:`~eagle.fields.Many2one`
...
.. autodoc documents descriptors as attributes, even for the *definition* of
   descriptors. As a result automodule:: eagle.fields lists all the field
...
.. autoclass:: eagle.fields.Field

.. autoclass:: eagle.fields.Char
    :show-inheritance:

.. autoclass:: eagle.fields.Boolean
    :show-inheritance:

.. autoclass:: eagle.fields.Integer
    :show-inheritance:

.. autoclass:: eagle.fields.Float
    :show-inheritance:

.. autoclass:: eagle.fields.Text
    :show-inheritance:

.. autoclass:: eagle.fields.Selection
    :show-inheritance:

.. autoclass:: eagle.fields.Html
    :show-inheritance:
...
:func:`~eagle.fields.Date.to_date` or :func:`~eagle.fields.Datetime.to_datetime`
...
.. autoclass:: eagle.fields.Many2one
    :show-inheritance:

.. autoclass:: eagle.fields.One2many
    :show-inheritance:

.. autoclass:: eagle.fields.Many2many
    :show-inheritance:

.. autoclass:: eagle.fields.Reference
    :show-inheritance:
...
* :meth:`~eagle.models.Model.search` returns a recordset, no point in e.g.
  browsing its result
* ``fields.related`` and ``fields.function`` are replaced by using a normal
  field type with either a ``related=`` or a ``compute=`` parameter
* :func:`~eagle.api.depends` on ``compute=`` methods **must be complete**,
...
* the decorators :func:`~eagle.api.model` and :func:`~eagle.api.multi` are
  for bridging *when calling from the old API context*, for internal or pure
  new-api (e.g. compute) they are useless
* remove :attr:`~eagle.models.Model._default`, replace by ``default=``
...
* the normal new-api import is ``from eagle import fields, models``. If
  ...
  fields, models``
* avoid the :func:`~eagle.api.one` decorator, it probably does not do what
  you expect
* remove explicit definition of :attr:`~eagle.models.Model.create_uid`,
  :attr:`~eagle.models.Model.create_date`,
  :attr:`~eagle.models.Model.write_uid` and
  :attr:`~eagle.models.Model.write_date` fields: they are now created as
...
* when straight conversion is impossible (semantics can not be bridged) or the
  ...
  implementations for the same method name using :func:`~eagle.api.v7` and
  :func:`~eagle.api.v8`. The method should first be defined using the
  old-API style and decorated with :func:`~eagle.api.v7`, it should then be
  re-defined using the exact same name but the new-API style and decorated
  with :func:`~eagle.api.v8`. Calls from an old-API context will be
...
* uses of :attr:`~eagle.models.Model._columns` or
  :attr:`~eagle.models.Model._all_columns` should be replaced by
  :attr:`~eagle.models.Model._fields`, which provides access to instances of
  new-style :class:`eagle.fields.Field` instances (rather than old-style
  :class:`eagle.osv.fields._column`).

  Non-stored computed fields created using the new API style are *not*
  available in :attr:`~eagle.models.Model._columns` and can only be
  inspected through :attr:`~eagle.models.Model._fields`
* reassigning ``self`` in a method is probably unnecessary and may break
  translation introspection
* :class:`~eagle.api.Environment` objects rely on some threadlocal state,
  which has to be set up before using them. It is necessary to do so using the
  :meth:`eagle.api.Environment.manage` context manager when trying to use
  the new API in contexts where it hasn't been set up yet, such as new threads
  or a Python interactive environment::

    >>> from eagle import api, modules
...
:class:`~eagle.api.Environment` (for :attr:`~eagle.api.Environment.cr`,
:attr:`~eagle.api.Environment.user` and
:attr:`~eagle.api.Environment.context`) or the current recordset (for ``id``
and ``ids``).
...
* disabling it entirely, by decorating a method with
  :func:`~eagle.api.noguess` there will be no bridging and methods will be
...
* defining the bridge explicitly, this is mostly for methods which are matched
  ...
  (e.g. :func:`~eagle.api.cr_uid_context`) which also passes the current
  context *by keyword*.
* dual implementations using :func:`~eagle.api.v7` and
  :func:`~eagle.api.v8` will be ignored as they provide their own "bridging"
