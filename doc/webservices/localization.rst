...
Although some additional types could be created in a localization module, we encourage the usage of the existing types in the `account/data/data_account_type.xml <https://github.com/eagle/eagle/blob/12.0/addons/account/data/data_account_type.xml>`_ file.
