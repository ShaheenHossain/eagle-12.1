# Sign the Eagle ERP CLA

In order for your contribution to Eagle ERP to be accepted, you have to sign the
Eagle ERP Contributor License Agreement (CLA). More information about this
...
3. An Eagle ERP R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Eagle ERP, the file would be
    `doc/cla/corporate/eagle.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Eagle ERP Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `eagle-erp.com`.  In that case someone from the Eagle ERP team will
make the pull request on your behalf.

* Printable Eagle ERP CCLA v1.0 https://www.eagle-erp.com/files/legal/Eagle ERP-CCLA-v1.0.pdf
* Printable Eagle ERP ICLA v1.0 https://www.eagle-erp.com/files/legal/Eagle ERP-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Eagle ERP is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Eagle ERP project

* protect the Eagle ERP project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Eagle ERP project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Eagle ERP project under specific
...
The Eagle ERP CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Eagle ERP S.A. to use, modify and
...
(ICLA) of Eagle ERP.  The agreement is executed by adding your name and
...
removed from the Eagle ERP project.
